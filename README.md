...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oojetvi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oojetvi.containers.anotherwebservice.com/
...
```
git clone git@github.com:emilio8458/container-oojetvi.git
cd container-oojetvi
```
...
```
docker attach container-oojetvi
```
